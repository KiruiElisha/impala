...
class ReceivablePayableReport(object):
    ...
    def append_payment_term(self, row, d, term):
        if (
            ...
            invoiced = flt(
                flt(d.payment_amount) * flt(d.conversion_rate), self.currency_precision
            )
            # invoiced = d.payment_amount
    ...
    def get_future_payments_from_journal_entry(self):
        ...
        # else:
        #     amount_field = (
        #         "jea.debit - " if self.party_type == "Supplier" else "jea.credit"
        #     )
        amount_field = (
            "jea.debit_in_account_currency - jea.credit_in_account_currency"
            if self.party_type == "Supplier"
    ...
    def get_return_entries(self):
        doctype = (
            "Sales Invoice" if self.party_type == "Customer" else "Purchase Invoice"
        )
