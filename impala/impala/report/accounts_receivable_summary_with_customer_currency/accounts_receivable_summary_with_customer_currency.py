...
from impala.impala.report.accounts_receivable_summary_with_customer_currency.party import (
    get_partywise_advanced_payment_amount,
)
from impala.impala.report.accounts_receivable_summary_with_customer_currency.accounts_receivable_edited import (
...
class AccountsReceivableSummary(ReceivablePayableReport):
    ...
    def get_columns(self):
        ...
        credit_debit_label = (
            "Credit Note" if self.party_type == "Customer" else "Debit Note"
        )
