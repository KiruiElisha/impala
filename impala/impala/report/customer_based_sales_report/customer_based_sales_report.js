...
frappe.query_reports["Customer Based Sales Report"] = {
	"filters": [
		{
			"fieldname" : "company",
			"fieldtype": "Link",
	...
	"render": function (report) {
		var coldIndex = report.columns.findIndex((col) => col.id === "customer");
		report.data.forEach(function (row) {
			var value = row[coldIndex];
			value.formatted = `<div class="left-align">${value.formatted}</div>`
		});
