	...
	if filters.get("level_1") and filters.get("level_1") != "":
		...
		if level_1:
			if not filters.get("level_2") and not filters.get("level_3") and  not filters.get("value") and not filters.get("range"):
				grandTotals = {"level_1": "<b style='color: Blue; font-family: sans-serif; font-size: 16px;'>Grand Totals</b>", "amount" : 0.0, "qty" : 0, "item_cost": 0.0, "amount_exclusive" : 0.0, "amount_inclusive" : 0.0,
				 				"gross_profit" : 0.0, "rate": 0.0, "sales_person_contrib": 0.0}
				for i in level_1:
					subTotals = {"level_1": f"""<b style='color: DarkSlateGray; font-family: sans-serif; font-size: 14px;'>{i.get("level_1")}</b>""", "amount" : 0.0, "qty" : 0, "item_cost": 0.0, "amount_exclusive" : 0.0, "amount_inclusive" : 0.0,
							 "gross_profit" : 0.0, "rate": 0.0, "sales_person_contrib": 0.0}
				...
				for i in level_1:
					subTotals1 = {"level_1": f"""<b style='color: DarkSlateGray; font-family: sans-serif; font-size: 14px;'>{i.get("level_1")}</b>""", "amount" : 0.0, "qty" : 0, "item_cost": 0.0, "amount_exclusive" : 0.0, "amount_inclusive" : 0.0,
					 				"gross_profit" : 0.0, "rate": 0.0, "sales_person_contrib": 0.0}
					...
					for b in level_2:
						...
						subTotals2 = {"level_2": f"""<b style='color: DarkSlateGray; font-family: sans-serif; font-size: 14px;'>{b.get("level_2")}</b>""", "amount" : 0.0, "qty" : 0, "item_cost": 0.0, "amount_exclusive" : 0.0, "amount_inclusive" : 0.0,
						 			"gross_profit" : 0.0, "rate": 0.0, "sales_person_contrib": 0.0}
				...
				for i in level_1:
					...
					for b in level_2:
						...
						for c in level_3:
							subTotals3 = {"level_3": f"""<b style='color: DarkSlateGray; font-family: sans-serif; font-size: 14px'>{c.get('level_3')}</b>""", "amount" : 0.0, "qty" : 0, "item_cost": 0.0, "amount_exclusive" : 0.0, "amount_inclusive" : 0.0,
									 "gross_profit" : 0.0, "rate": 0.0, "sales_person_contrib": 0.0}
...
def group_level_1_1(conditions = "" , grouping_level_1 = None,  grouping_level_value  = None, range_by = None , filters = None):
	if grouping_level_1:
		...
		data =  frappe.db.sql(""" select  {} as level_1,  s.posting_date, s.name  
			...
			i.base_amount as amount, i.base_amount as amount_exclusive, i.base_net_amount as amount_inclusive, 
...
def get_data_normal(conditions   = "", filters = ""):
		...
		query =  frappe.db.sql(""" select  s.posting_date, s.name as voucher_no, s.currency as currency, i.item_code ,  i.item_name ,   i.qty,  s.status ,   i.amount as amount ,
			s.tax_type ,  i.total_tax_percentage ,  i.item_group ,
			i.base_amount as amount, i.base_amount as amount_exclusive, i.base_net_amount as amount_inclusive, i.idx as idx,
		...
		grandTotals = {"voucher_no": "<h4>Grand Totals<h4>", "amount" : 0.0, "qty" : 0, "item_cost": 0.0, "amount_exclusive" : 0.0,
		 				"amount_inclusive" : 0.0, "gross_profit" : 0.0, "rate": 0.0, "sales_person_contrib": 0.0}
