...
from impala.impala.report.financial_statements_customized import get_columns, get_data, get_period_list
...
def execute(filters=None):
	...
	company_currency = filters.presentation_currency or frappe.get_cached_value('Company',  filters.company,  "default_currency")\
	...
	income = get_data(conversion_factor,
	...
	expense = get_data(conversion_factor,
