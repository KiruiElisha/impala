...
def get_data(conditions = "" ):
	data =  frappe.db.sql(""" select  s.transaction_date, s.name  as voucher_no , i.item_code , i.qty , i.item_group,
...
def get_columns(conditions,filters):
	...
	columns = [
...

		{
			...
			"fieldname": "amount_exclusive",
			"label": _("Sales Return Exclusive"),
			"options" : "Sales Order Item",
			"fieldtype": "Currency",
			"width": 150
		},
...
# 			value =  frappe.db.sql(""" select  s.transaction_date, s.name  as voucher_no , i.item_code , i.qty , i.item_group as item_group, 
# 				i.amount as amount_exclusive , i.amount as item_cost,  i.amount as amount_inclusive ,i.amount as gross_profit ,
# 				i.amount as gp,  s.territory , s.customer as customer , s.project , sp.sales_person ,  s.cost_center as division , s.status as status,
